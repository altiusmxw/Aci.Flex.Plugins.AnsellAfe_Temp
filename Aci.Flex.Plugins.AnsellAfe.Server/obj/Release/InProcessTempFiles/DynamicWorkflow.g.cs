...
namespace Aci.Flex.Plugins.AnsellAfe.Server.Workflow {
    ...
    public partial class DynamicWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(DynamicWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(DynamicWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(DynamicWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".DynamicWorkflow.g.xaml") || resource.Equals("DynamicWorkflow.g.xaml"))) {
                    return resource;
                }
            }
